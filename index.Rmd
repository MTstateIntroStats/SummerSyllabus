...
## Section 001 Instructor
**Aaron Akyea Mensah**  
Email: aaronakyeamensah@montana.edu  
Office: Wilson 2-268  
...
* [STAT 216 Summer I calendar](calendars/Sum1_23-Stat216_Calendar.pdf)
...
2. STAT 216 Coursepack --- our PDF workbook with reading guides and activities. You can purchase the workbook for under $15 and have it shipped to you [here](https://www.lulu.com/shop/st-hancock-and-jade-schmidt-and-melinda-yager/stat-216-summer-2023-coursepack/paperback/product-52pnw7.html?page=1&pageSize=4). Students are expected to bring the coursepack to class each day and to complete the activities within the coursepack. Unit 1 of the coursepack is provided here in case it takes more than a week to receive your coursepack. 

* [_STAT 216 Coursepack_: Unit 1](calendars/Unit1_IntroStatActivities-SU23.pdf)
...
You will be expected to complete the assigned textbook reading and D2L videos using the reading guides provided in the coursepack prior to attending the in-class activity for each week. Concept check quiz questions will be completed in Gradescope. *(Note that you can rewind/review the video as much as you like, and may submit your Video Quiz in Gradescope as many times as you like up through the due date.  You can also check your snwers in Gradescope after submitting (prior to the due date) by clicking on each question's hyperlink.  If a explanation appears, that means you answered the question correctly.)* 

* Video quizzes will *typically* be due each **class day at 10 am MST**.

### Activities (10%)

Every class day, you will meet with your classmates and instructor to work through that day's coursepack group activities. Attendance and completion of the activity counts towards this portion of your grade. 

* Activities must be completed in the Stat 216 Coursepack. **If you prefer to complete the activity on a pdf copy using a stylus-enabled device, please speak to your instructor, and she will provide you with a PDF copy of the coursepack.**
...
* Please refer to the [STAT 216 Summer I calendar](calendars/Sum1_23-Stat216_Calendar.pdf) for exam dates.
...
Individual final exam will be **Thursday, June 22 from 12:00 - 1:50pm**. 
