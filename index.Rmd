...
* [STAT 216 Summer I calendar](calendars/Sum1_22-Stat216_Calendar.pdf)
...
2. [_STAT 216 Coursepack_](calendars/IntroStatActivities-SU22.pdf) --- our PDF workbook with reading guides and activities. You can purchase the workbook for under $15 and have it shipped to you [here](https://www.lulu.com/en/us/shop/stacey-hancock-and-jade-schmidt-and-melinda-yager/stat-216-summer-coursepack/paperback/product-4z7m7g.html?page=1&pageSize=4). Students are expected to bring the coursepack to class each day and to complete the activities within the coursepack. Unit 1 of the coursepack is provided here in case it takes more than a week to receive your coursepack. 

* [_STAT 216 Coursepack_: Unit 1](calendars/Unit1_IntroStatActivities-SU22.pdf)
...
* Video quizzes will *typically* be due each **class day at 10am MST**.
...
* Each group will turn in selected questions from the lab to Gradescope. Labs are due **Tuesdays and Thursdays at 8pm Mountain Time each week**.
...
* Weekly assignments will *typically* be due each **Tuesday and Thursday at 8pm MST**
...
* Please refer to the [STAT 216 Summer I calendar](calendars/Sum1_22-Stat216_Calendar.pdf) for exam dates.
